...
public class NhatKiMonTheThao implements Serializable {
    private int idhd;
    private int idMTT;
    ...
    public NhatKiMonTheThao(int idhd, int idMTT, String tenMonTT, float thoiGian, String ngay, float NLTH, Integer idUser) {
        this.idhd = idhd;
        this.idMTT = idMTT;
        TenMonTT = tenMonTT;
        ThoiGian = thoiGian;
